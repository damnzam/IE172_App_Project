...
layout = html.Div(
    [
        ...
        html.P(children=["Hi ",html.B("Hooman"),"! Thank you for your interest in giving a furever home to one of our rescues. We have a lot of rescue dogs and cats ready for adoption both at the BULACAN SHELTER and the BACOLOD SHELTER. Our adoption process is super easy!"]),
        html.B("Adoption Process:"),
        html.Ol(
            [
        ...
        html.P(children=[html.B("IMPORTANT"),": Our Shelters are located in BULACAN and BACOLOD. Adopters should be willing to travel to our Shelters to meet and pick-up the Rescue they want to adopt."]),
        ...
        dbc.Button("GET STARTED", color='dark', href="/register", className="btn-custom")
    ], className="adopt-apply"
)
